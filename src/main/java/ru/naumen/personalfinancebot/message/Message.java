...
public class Message {
    ...
    /**
     * Сообщение о некорректно переданном годе для созданию бюджета.
     */
    public static final String INCORRECT_BUDGET_YEAR_ARG = "Год введен неверно! Дальше 3000 года не стоит планировать.";

    /**
     * Сообщение, предоставляющую пользователю информацию о доступных командах для пользователя
     */
    ...
    /**
     * Сообщение об ошибке если передал дату начала, которая позднее даты конца
     */
    public static final String BUDGET_LIST_FROM_IS_AFTER_TO = "Дата начала не может быть позднее даты конца периода!";

    /**
     * Префикс для спискаа запланированных бюджетов.
     */
    ...
    /**
     * Сообщение об отсутсвии бюджета за конкретную дату
     */
