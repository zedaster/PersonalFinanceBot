...
public class ReportService {
    ...
    /**
     * Подготавливает отчёт по средним суммам операций по стандартным категориям
     * Т.е. по каждой категории для каждого пользователя высчитывается суммы, а затем ищется среднее из этой суммы.
     *
